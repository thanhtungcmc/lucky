...
class BoardView extends StatefulWidget {
  ...
  final bool showImg;
  const BoardView({Key? key, required this.angle,required this.showImg, required this.current, required this.items})
      : super(key: key);
        ...
        Transform.rotate(
          ...
          child: Stack(
            ...
            children: <Widget>[
              ...
              if(widget.showImg) for (var luck in widget.items) ...[_buildImage(luck)],
            ],
          ),
        ),
        Container(
    ...
    return Transform.rotate(
      ...
      child: Container(
        ...
        child: ConstrainedBox(
          ...
          child: Image.asset(Assets.imageUrlList[widget.items.indexOf(luck)]),
        ),
      ),
    );
  }
